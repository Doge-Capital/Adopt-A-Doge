    ...
    return (
        <div className="bg-[#f5f5f5] h-full">
            <div className={styles.header}>
                <h1 className="pt-10 mb-14 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl text-center">
            ...
            <div>
                <div className="flex justify-center items-center">
                    <div className=" max-w-1/2 hidden justify-center items-center sm:flex">
                        <Image
                    ...
                    <div className="flex flex-col w-3/4 sm:w-1/2 pt-32">
            ...
            <div>
                <div className="flex flex-col sm:flex-row w-1/2 m-auto justify-center items-center">
                    <div className="flex text-xl bg-[#2278F9] px-10 rounded-full text-white w-fit mx-3 py-4 hover:border-[#2278F9] border-2 hover:bg-white hover:text-[#2278F9] cursor-pointer mt-14 mb-4 sm:mb-14">
                        <a href="https://thedogecapital.com/" target="_blank" rel="noopener noreferrer" className="text-center">
                            Learn More
                        </a>
                    </div>
                    <div
                        className="flex text-xl bg-[#2278F9] px-10 rounded-full text-white w-fit mx-3 py-4 hover:border-[#2278F9] border-2 hover:bg-white hover:text-[#2278F9] cursor-pointer mt-4 mb-14 sm:mt-14"
                        onClick={() => router.back()}
                    >
                        Back
                    </div>
