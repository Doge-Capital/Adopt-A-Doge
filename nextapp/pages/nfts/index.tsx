                    ...
                    <div className="flex align-middle justify-between py-4">
                        <div className="text-[1.125rem] opacity-[0.75] flex-row items-center gap-4 font-medium ">
                            ...
                            <h3 className="text-[#D44C4C] text-lg font-bold mt-10">
                                NOTE: You can only burn up to 4 NFTs at once.
                            </h3>
                        </div>
                        <div>
                            ...
                            <button className="text-lg bg-[#2278F9] rounded-sm text-white px-4 py-2 text-center" onClick={() => {console.log(selectedNfts)}}>
                                Log NFTs object
                            </button>
                        </div>
                    </div>
