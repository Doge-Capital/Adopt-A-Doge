    ...
    return (
        <div className="bg-[#f5f5f5] sticky top-0 z-50 border-b-4 border-slate-300">
            <div className="flex w-full justify-center sm:justify-between gap-2">
                <div className="flex gap-2 ml-2 sm:ml-5 items-center justify-center text-xl text-center cursor-pointer" onClick={() => router.push("/home")}>
                    <Image
                ...
                <div className="flex justify-center sm:justify-end h-[10vh] items-center mx-2 sm:mr-5 gap-3 sm:gap-6">
                    <div className=" text-xl hover:translate-y-[-2px] rounded-full w-8 text-center border-2 border-black cursor-pointer" onClick={() => router.push("/about")}>
                        i
                    </div>
